...
internal static class AllChecksOutSeedData
{
    ...
    public static void Seed(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AllChecksOut.FunctionsApi.Entities.Task>().HasData(Tasks());
    ...
    private static AllChecksOut.FunctionsApi.Entities.Task[] Tasks()
    {
    ...
    private static IEnumerable<AllChecksOut.FunctionsApi.Entities.Task> BuildAnnualTasks(string participantPrefix, string caseId, string[] templateTaskIds, string[] statuses)
    {
    ...
    private static AllChecksOut.FunctionsApi.Entities.Task Task(string id, string caseId, string templateTaskId, string status) => Base(new AllChecksOut.FunctionsApi.Entities.Task
    {
        Id = id,
        CaseId = caseId,
