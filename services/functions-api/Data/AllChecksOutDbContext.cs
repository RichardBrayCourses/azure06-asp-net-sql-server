using AllChecksOut.FunctionsApi.Entities;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata.Builders;

namespace AllChecksOut.FunctionsApi.Data;
...
public class AllChecksOutDbContext(DbContextOptions<AllChecksOutDbContext> options) : DbContext(options)
{
    ...
    public DbSet<AllChecksOut.FunctionsApi.Entities.Task> Tasks => Set<AllChecksOut.FunctionsApi.Entities.Task>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        ConfigureEntity(modelBuilder.Entity<AllChecksOut.FunctionsApi.Entities.Task>());
        ...
        modelBuilder.Entity<AllChecksOut.FunctionsApi.Entities.Task>().ToTable("Tasks");
    ...
    private static void ConfigureStrings(ModelBuilder modelBuilder, bool isSqlServer)
    {
        ...
        if (isSqlServer)
        {
            ...
            modelBuilder.Entity<AllChecksOut.FunctionsApi.Entities.Task>().Property(entity => entity.ResponseJson).HasColumnType("nvarchar(max)");
            modelBuilder.Entity<AllChecksOut.FunctionsApi.Entities.Task>().Property(entity => entity.EvidenceJson).HasColumnType("nvarchar(max)");
