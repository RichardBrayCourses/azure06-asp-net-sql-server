...
AZURE_KEY_VAULT_NAME="${AZURE_KEY_VAULT_NAME:-$AZURE_APP_NAME-kv}"
AZURE_SQL_ADMIN_PASSWORD_SECRET_NAME="${AZURE_SQL_ADMIN_PASSWORD_SECRET_NAME:-sql-admin-password}"
